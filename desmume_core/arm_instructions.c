...
#define OP_SUBS(a, b)          cpu->R[REG_POS(i,12)] = v - shift_op;\
     if(REG_POS(i,12)==15)\
     {\
          Status_Reg SPSR = cpu->SPSR;\
          armcpu_switchMode(cpu, SPSR.bits.mode);\
...
#define OP_MOVS(a, b)    cpu->R[REG_POS(i,12)] = shift_op;\
...
#define OP_BICS(a, b)    cpu->R[REG_POS(i,12)] = cpu->R[REG_POS(i,16)] & (~shift_op);\
     if(REG_POS(i,12)==15)\
     {\
          Status_Reg SPSR = cpu->SPSR;\
          armcpu_switchMode(cpu, SPSR.bits.mode);\
...
#define OP_MVNS(a, b)   cpu->R[REG_POS(i,12)] = ~shift_op;\
     if(REG_POS(i,12)==15)\
     {\
          Status_Reg SPSR = cpu->SPSR;\
          armcpu_switchMode(cpu, SPSR.bits.mode);\
...
{
	u32 v = cpu->R[REG_POS(cpu->instruction,8)];
	cpu->R[REG_POS(cpu->instruction,16)] = cpu->R[REG_POS(cpu->instruction,0)] * v;
...
{
	u32 v = cpu->R[REG_POS(cpu->instruction,8)];
	u32 a = cpu->R[REG_POS(cpu->instruction,0)];
	u32 b = cpu->R[REG_POS(cpu->instruction,12)];
	cpu->R[REG_POS(cpu->instruction,16)] = a * v + b;
...
static u32 FASTCALL  OP_MUL_S(armcpu_t *cpu)
{
	...
	cpu->CPSR.bits.N = BIT31(cpu->R[REG_POS(cpu->instruction,16)]);
	cpu->CPSR.bits.Z = (cpu->R[REG_POS(cpu->instruction,16)]==0);
...
{
	u32 v = cpu->R[REG_POS(cpu->instruction,8)];
	cpu->R[REG_POS(cpu->instruction,16)] = cpu->R[REG_POS(cpu->instruction,0)] * v + cpu->R[REG_POS(cpu->instruction,12)];
	cpu->CPSR.bits.N = BIT31(cpu->R[REG_POS(cpu->instruction,16)]);
	cpu->CPSR.bits.Z = (cpu->R[REG_POS(cpu->instruction,16)]==0);
...
{
	u32 v = cpu->R[REG_POS(cpu->instruction,8)];
	u64 res = (u64)v * (u64)cpu->R[REG_POS(cpu->instruction,0)];
	
	cpu->R[REG_POS(cpu->instruction,12)] = (u32)res;
	cpu->R[REG_POS(cpu->instruction,16)] = (u32)(res>>32);
...
{
	u32 v = cpu->R[REG_POS(cpu->instruction,8)];
	u64 res = (u64)v * (u64)cpu->R[REG_POS(cpu->instruction,0)] + (u64)cpu->R[REG_POS(cpu->instruction,12)];
...
static u32 FASTCALL  OP_UMULL_S(armcpu_t *cpu)
{
	...
	cpu->CPSR.bits.N = BIT31(cpu->R[REG_POS(cpu->instruction,16)]);
	cpu->CPSR.bits.Z = (cpu->R[REG_POS(cpu->instruction,16)]==0) & (cpu->R[REG_POS(cpu->instruction,12)]==0);
...
// MUL_Mxx_END()
#define MUL_SMxxL_END(c) MUL_Mxx_END(c)
...
static u32 FASTCALL  OP_SMUL_B_B(armcpu_t *cpu)
{
	...
	cpu->R[REG_POS(cpu->instruction,16)] = (u32)(LWORD(cpu->R[REG_POS(cpu->instruction,0)])* LWORD(cpu->R[REG_POS(cpu->instruction,8)]));
...
static u32 FASTCALL  OP_SMUL_B_T(armcpu_t *cpu)
{
	...
	cpu->R[REG_POS(cpu->instruction,16)] = (u32)(LWORD(cpu->R[REG_POS(cpu->instruction,0)])* HWORD(cpu->R[REG_POS(cpu->instruction,8)]));
...
static u32 FASTCALL  OP_SMUL_T_B(armcpu_t *cpu)
{
	...
	cpu->R[REG_POS(cpu->instruction,16)] = (u32)(HWORD(cpu->R[REG_POS(cpu->instruction,0)])* LWORD(cpu->R[REG_POS(cpu->instruction,8)]));
...
static u32 FASTCALL  OP_SMUL_T_T(armcpu_t *cpu)
{
	...
	cpu->R[REG_POS(cpu->instruction,16)] = (u32)(HWORD(cpu->R[REG_POS(cpu->instruction,0)])* HWORD(cpu->R[REG_POS(cpu->instruction,8)]));
...
static u32 FASTCALL  OP_LDMIA(armcpu_t *cpu)
{
     ...
     u32 * registres = cpu->R;
     TWaitState* waitState = MMU.MMU_WAIT32[cpu->proc_ID];
...
//		IdeasLog(cpu);
	...
	BOOL bypassBuiltinSWI = 
		(cpu->intVector == 0x00000000 && cpu->proc_ID==0)
		|| (cpu->intVector == 0xFFFF0000 && cpu->proc_ID==1);
...
static u32 FASTCALL OP_BKPT(armcpu_t *cpu)
{
	...
	last_bkpt = i;
//	static u32 last_bkpt = cpu->instruction;
...
//u32 (*FASTCALL arm_instructions_set[4096])(armcpu_t *cpu)={
